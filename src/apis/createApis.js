...
export const createTeam = async (navigate, startStation, endStation, newStartTime, maxPeople, accessToken) => {
    ...
    await serverApi.post(`https://port-0-server-2rrqq2blmoc3kpx.sel5.cloudtype.app/team/create/`, {'start_station':startStation, 'arrival_station':endStation, 'start_time':newStartTime, 'maximum_member':maxPeople, 'master_member':2}).then((response) => {
      // success
